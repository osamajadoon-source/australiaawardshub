...
# Titles that ARE (or reduce to, after stripping common words) just one of
# these bare/near-bare words are almost always a nav label or section
# heading picked up as a page title — never an individual project.
BARE_GENERIC_TITLES = {
