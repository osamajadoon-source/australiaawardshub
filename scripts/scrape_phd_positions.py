...
<head>
  ...
  <style>
    *, *::before, *::after {{ box-sizing: border-box; margin: 0; padding: 0; }}
    ...
    .notice-box {{ background: #fff8ec; border-left: 3px solid var(--amber); border-radius: 8px; padding: 1rem 1.25rem; margin: 1.25rem 0; font-size: 0.92rem; color: #5a4530; }}
...
<div class="page-body">
  <article>
    ...
    <div class="notice-box">
      Editorial note: this listing was found automatically and is pending a full write-up.
      <!-- REVIEWER: replace this paragraph with 2-4 original sentences describing
           the project (topic, what the student will do, why it matters) before
           merging. Do not copy text from the official listing — write it in your
           own words, using the facts from the source page. -->
    </div>
