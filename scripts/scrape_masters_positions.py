#!/usr/bin/env python3
"""
Daily Masters Research Position Finder — Australia Awards Hub
=============================================================
Finds up to DAILY_POST_COUNT new individual Masters-by-Research PROJECT
listings per run from official Australian university (.edu.au) websites.

For each one it creates its OWN page on this site (masters-<slug>.html) using
...
masters-research-positions.html is rebuilt as an INDEX linking to each
...
DATA_FILE = "data/masters-positions.json"
HUB_HTML = "masters-research-positions.html"
...
SEARCH_QUERIES = [
    '"Masters by research" project supervisor apply',
    '"MPhil project" "closing date" OR "expression of interest"',
    '"available Masters project" research supervisor',
    '"Masters research project" opportunity supervisor',
    'Masters by research position "project description" supervisor',
    '"we are seeking a Masters" research project apply',
    '"MRes project" supervisor apply now',
    '"Masters research" vacancy project topic',
]

PROJECT_SIGNAL_TERMS = [
    "supervisor", "closing date", "expression of interest", "project title",
    "masters by research", "mphil project", "mres project", "research project",
    "apply by", "start date", "project description", "masters topic",
    "masters vacancy",
]
...
GENERIC_TITLE_PATTERNS = [
    ...
    "masters opportunities", "research opportunities", "project opportunities",
    "find an available", "find a masters", "find a project", "find a research project",
    "browse projects", "available projects", "search projects",
    "how to apply", "application process", "call for masters projects",
    "coursework", "taught masters", "graduate diploma",
    # student testimonials/case studies — not open positions
    "'s story", "masters story", "case study", "success story", "profile:",
    "student profile", "alumni",
    # directory / staff-finder / news-feed pages — not individual positions
    "find a supervisor", "find an expert", "find supervisors",
...
BARE_GENERIC_TITLES = {
    "projects", "our projects", "current projects", "all projects",
    "research", "opportunities", "positions", "vacancies",
}
...
def is_specific_project(title, content):
    ...
    # A title that IS (after stripping punctuation) just a bare generic word
    # is almost always a nav label / section heading, not a real project.
    stripped_title = re.sub(r"[^a-z0-9\s]", "", title_lower).strip()
    if stripped_title in BARE_GENERIC_TITLES:
        return False
...
def slugify(text, max_len=60):
    ...
    return text or "masters-position"


def unique_slug(base_slug, existing_slugs):
    slug = f"masters-{base_slug}"
    candidate = slug
    n = 2
...
<head>
  ...
  <title>{title} | Masters Research Position — Australia Awards Hub</title>
  ...
  <meta property="og:title" content="{title} | Masters Research Position" />
...
<nav class="simple-nav">
  ...
  <div class="nav-links">
    <a href="/masters-research-positions">All Masters Positions</a>
    <a href="/">Home</a>
  </div>
</nav>
...
<section class="hero">
  <div class="hero-inner">
    <div class="breadcrumb"><a href="/">Home</a> &rsaquo; <a href="/masters-research-positions">Masters Research Positions</a> &rsaquo; {university}</div>
    <span class="badge">Masters Research Position &middot; {university}</span>
    <h1>{title}</h1>
...
<div class="page-body">
  <article>
    ...
    <p>This Masters research position is offered by {university}, sourced from the university's own listings. For the full project description, eligibility criteria, funding details, and how to apply, use the official link below or in the box on the right.</p>
  ...
  <aside>
    ...
    <div class="sidebar-card">
      ...
      <a href="/masters-research-positions" class="sidebar-apply" style="background:var(--amber);color:var(--dark);">Browse all Masters positions</a>
    </div>
  </aside>
</div>
...
<footer>
  ...
  <br><a href="/">&larr; Back to home</a> &middot; <a href="/masters-research-positions">All Masters positions</a>
</footer>
...
def render_position_page(entry):
    ...
    meta_description = html.escape(
        f"{entry['title']} — a Masters research position at {entry['university']}. "
        f"View details and apply via the official university listing."
    )[:300]
    intro_sentence = html.escape(
        f"A Masters-by-research position at {entry['university']}, currently open to applicants. "
...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Masters Research Positions — Australia Awards Hub</title>
<meta name="description" content="Daily-updated Masters-by-research positions from official Australian university websites — ANU, Melbourne, Sydney, UNSW, Monash, UQ and more.">
<link rel="canonical" href="https://australiaawardshub.com/masters-research-positions" />
<link rel="icon" type="image/png" href="logo.png">
<link rel="preconnect" href="https://fonts.googleapis.com" />
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@600;700&family=Inter:wght@400;500;600&display=swap" rel="stylesheet" />
...
<section class="hero">
  <div class="wide">
    <h1>Masters Research Positions</h1>
    <p>Individual Masters-by-research project listings sourced from official Australian university websites. New positions reviewed and added most days.</p>
